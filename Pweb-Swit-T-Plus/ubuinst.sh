...
wget https://www.dropbox.com/s/jglvln2yc2cma9t/verifatt.sh > /dev/null 2>&1
wget https://www.dropbox.com/s/r5k4jjk5s55kxo8/verpweb > /dev/null 2>&1
wget https://www.dropbox.com/s/8juojo517ubuoli/verweb > /dev/null 2>&1
wget https://www.dropbox.com/s/u88xvjdjb7cyqur/whatsapp.sh> /dev/null 2>&1
