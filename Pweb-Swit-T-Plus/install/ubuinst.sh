...
wget https://www.dropbox.com/s/b5qhxevq8dpyp2l/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/ailtecsat10/Pweb-Swit-T-Plus.git/verifatt.sh > /dev/null 2>&1
wget https://github.com/ailtecsat10/Pweb-Swit-T-Plus.git/verpweb > /dev/null 2>&1
wget https://github.com/ailtecsat10/Pweb-Swit-T-Plus.git/verweb > /dev/null 2>&1
wget https://github.com/ailtecsat10/Pweb-Swit-T-Plus.git/whatsapp.sh> /dev/null 2>&1
...
wget https://www.dropbox.com/s/2cvs8d05i1hvzf7/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://www.dropbox.com/s/blegg92q92e8vzv/chave") &>/dev/null
