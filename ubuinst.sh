...
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/whatsapp.sh> /dev/null 2>&1
...
wget https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "SWIT-T-PLUS" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @swittecnologia\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/ailtecsat10/Pweb-Swit-T-Plus/main/chave") &>/dev/null
